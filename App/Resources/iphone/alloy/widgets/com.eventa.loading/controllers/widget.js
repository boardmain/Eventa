function WPATH(s) {
    ...
    var path = -1 === index ? "com.eventa.loading/" + s : s.substring(0, index) + "/com.eventa.loading/" + s.substring(index + 1);
    return path;
}

function Controller() {
    new (require("alloy/widget"))("com.eventa.loading");
    this.__widgetId = "com.eventa.loading";
