...
function Controller() {
    new (require("alloy/widget"))("com.eventa.detailNavigation");
    this.__widgetId = "com.eventa.detailNavigation";
    ...
    true && parseInt(Ti.Platform.version.split(".")[0], 10) >= 7 && ($.Wrapper.top = "37dp");
    _.extend($, exports);
}
