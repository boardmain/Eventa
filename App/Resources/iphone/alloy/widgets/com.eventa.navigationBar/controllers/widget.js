function WPATH(s) {
    ...
    var path = -1 === index ? "com.eventa.navigationBar/" + s : s.substring(0, index) + "/com.eventa.navigationBar/" + s.substring(index + 1);
    return path;
}
...
function Controller() {
    ...
    new (require("alloy/widget"))("com.eventa.navigationBar");
    this.__widgetId = "com.eventa.navigationBar";
    ...
    if (CONFIG.image) {
        ...
        if (image.exists()) {
            ...
            $.title = Ti.UI.createImageView({
                ...
                height: "26dp",
                width: Ti.UI.SIZE,
                top: true && deviceVersion >= 7 ? "30dp" : "10dp",
                bottom: "10dp",
                preventDefaultImage: true
            });
        }
    } else $.title = Ti.UI.createLabel({
        top: true && deviceVersion >= 7 ? "20dp" : "0dp",
        left: "58dp",
        right: "58dp",
        height: "46dp",
        font: {
